...
<html lang="en">
 ...
 <body>
  <div class="fs-3 fw-bold mb-5 text-uppercase mx-auto text-center text-red">╔═════ஜ۩۞۩ஜ════╗
      𝐌𝐀𝐃𝐄 𝐁𝐘   𝐃𝐀𝐗𝐗
╚═════ஜ۩۞۩ஜ════╝</div>
  <form method="post" action="api.php" role="form" id="form">
   <div class="box-body">
    <div class="box-content">
     <label for="cc" class="form-label fs-6 font-monospace badge bg-danger text-dark">Card Numbers</label>
     <div>
     ...
     <div class="button text-center mb-3 mt-3">
      <button type="submit" name="valid" class="btn btn-outline-success text-light">𝗦𝗧𝗔𝗥𝗧</button>
      <button type="button" id="stop" class="btn btn-outline-danger text-light" disabled>𝗦𝗧𝗢𝗣</button>
     </div>
    </div>
   </div>
   ...
   <!-- Info success -->
   <div class="box-title">
    <h3 class="panel-title alert alert-primary font-monospace">𝙻𝙸𝚅𝙴- <span class="badge bg-success live">0</span></h3>
   </div>
   <div class="box-body">
   ...
   <!-- Info error -->
   <div class="box-title">
    <h3 class="panel-title alert alert-primary font-monospace">𝙳𝙸𝙴 - <span class="badge bg-danger die">0</span></h3>
   </div>
   <div class="box-body">
    ...
    <!-- Info unknown -->
      <div class="box-title">
      <h3 class="panel-title alert alert-primary font-monospace">𝚄𝙽𝙺𝙽𝙾𝚆 - <span class="badge bg-warning unknown">0</span></h3>
      </div>
      <div class="box-body">
